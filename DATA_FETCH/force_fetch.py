    ...
    try:
        with connect.cursor() as cursor:
            for s in list_force:
                time_list = []
                average = 0
                sql = "select time_logo from pedestrian.danger_double where case_s=0 and density=0.8 and radius=9 and radius_ob=30 and radius_v=0 and force_s= '%s' and force_type=1 and peo_view=10"
